...
class ExperimentManager:
    ...
    def __init__(
        ...
        self.tensorboard_log = None if tensorboard_log == "" else tensorboard_log #os.path.join(tensorboard_log, self.env_name)
        # Wandbcalback
        self.wandb_model_save_path = None if wandb_model_save_path == "" else wandb_model_save_path #os.path.join(wandb_model_save_path, self.env_name)
        # above wandbcallback is an addition
    ...
    def learn(self, model: BaseAlgorithm) -> None:
        ...
        if self.wandb_model_save_path != "":
            ...
            kwargs["callback"] = WandbCallback(
                                gradient_save_freq=100,
                                model_save_freq=1000,
                                model_save_path=self.wandb_model_save_path,
                                verbose=2,
                                )
