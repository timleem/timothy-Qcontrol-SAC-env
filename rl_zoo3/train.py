...
def train() -> None:
    ...
    if args.track:
        ...
        run_name = f"{args.env}__{args.algo}__{args.seed}__{str(time.time())}"
        ...
        # args.model_save_path = f"models/{run_name}"
        args.tensorboard_log = os.path.join(run.dir,f"runs/")
        args.model_save_path = os.path.join(run.dir,f"models/")
    ...
    exp_manager = ExperimentManager(
        ...
        wandb_model_save_path=args.model_save_path,
    )
